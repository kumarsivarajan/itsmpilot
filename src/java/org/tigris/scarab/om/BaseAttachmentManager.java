    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Attachment";
     ...
     * Loads <code>Attachment</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Attachment getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Attachment with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Attachment getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Attachment) cacheGet(id);
    }
