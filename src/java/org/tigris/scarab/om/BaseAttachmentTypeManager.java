    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.AttachmentType";
     ...
     * Loads <code>AttachmentType</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttachmentType getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a AttachmentType with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected AttachmentType getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (AttachmentType) cacheGet(id);
    }
