    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.AttributeGroup";
     ...
     * Loads <code>AttributeGroup</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeGroup getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a AttributeGroup with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected AttributeGroup getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (AttributeGroup) cacheGet(id);
    }
