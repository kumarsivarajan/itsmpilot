    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Attribute";
     ...
     * Loads <code>Attribute</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Attribute getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Attribute with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Attribute getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Attribute) cacheGet(id);
    }
