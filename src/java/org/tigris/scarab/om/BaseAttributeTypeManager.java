    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.AttributeType";
     ...
     * Loads <code>AttributeType</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeType getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a AttributeType with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected AttributeType getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (AttributeType) cacheGet(id);
    }
