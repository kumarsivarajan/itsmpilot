    ...
    extends BasePeer
{
        ...
        throws TorqueException
    {
        ...
        int offset2 = numColumns + 1;
                    ...
                    AttributePeer.addSelectColumns(criteria);
                                    criteria.addJoin(AttributeValuePeer.ATTRIBUTE_ID, AttributePeer.ATTRIBUTE_ID);
                                    int offset3 = offset2 + AttributePeer.numColumns;
                                                                                
                    AttributeOptionPeer.addSelectColumns(criteria);
                                    criteria.addJoin(AttributeValuePeer.OPTION_ID, AttributeOptionPeer.OPTION_ID);
                                    int offset4 = offset3 + AttributeOptionPeer.numColumns;
                                                                                
                    ScarabUserImplPeer.addSelectColumns(criteria);
                                    criteria.addJoin(AttributeValuePeer.USER_ID, ScarabUserImplPeer.USER_ID);
        ...
        throws TorqueException
    {
        ...
        int offset2 = numColumns + 1;
                    ...
                    IssuePeer.addSelectColumns(criteria);
                                    criteria.addJoin(AttributeValuePeer.ISSUE_ID, IssuePeer.ISSUE_ID);
