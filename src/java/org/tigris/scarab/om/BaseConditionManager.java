    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Condition";
     ...
     * Loads <code>Condition</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Condition getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Condition with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Condition getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Condition) cacheGet(id);
    }
