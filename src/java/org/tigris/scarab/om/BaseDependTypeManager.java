    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.DependType";
     ...
     * Loads <code>DependType</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static DependType getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a DependType with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected DependType getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (DependType) cacheGet(id);
    }
