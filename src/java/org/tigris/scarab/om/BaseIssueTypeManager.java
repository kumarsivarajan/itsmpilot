    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.IssueType";
     ...
     * Loads <code>IssueType</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static IssueType getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a IssueType with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected IssueType getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (IssueType) cacheGet(id);
    }
