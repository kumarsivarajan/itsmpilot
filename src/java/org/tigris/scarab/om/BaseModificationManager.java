    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Modification";
     ...
     * Loads <code>Modification</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Modification getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Modification with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Modification getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Modification) cacheGet(id);
    }
