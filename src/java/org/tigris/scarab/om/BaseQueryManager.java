    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Query";
     ...
     * Loads <code>Query</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Query getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Query with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Query getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Query) cacheGet(id);
    }
