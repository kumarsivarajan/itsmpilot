    ...
    extends BasePeer
{
        ...
        throws TorqueException
    {
        ...
        int offset2 = numColumns + 1;
                    ...
                    ScarabModulePeer.addSelectColumns(criteria);
                                    criteria.addJoin(RModuleAttributePeer.MODULE_ID, ScarabModulePeer.MODULE_ID);
                                    int offset3 = offset2 + ScarabModulePeer.numColumns;
                                                                                
                    IssueTypePeer.addSelectColumns(criteria);
                                    criteria.addJoin(RModuleAttributePeer.ISSUE_TYPE_ID, IssueTypePeer.ISSUE_TYPE_ID);
        ...
        throws TorqueException
    {
        ...
        int offset2 = numColumns + 1;
                    ...
                    AttributePeer.addSelectColumns(criteria);
                                    criteria.addJoin(RModuleAttributePeer.ATTRIBUTE_ID, AttributePeer.ATTRIBUTE_ID);
