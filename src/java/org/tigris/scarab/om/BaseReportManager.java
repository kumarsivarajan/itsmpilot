    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Report";
     ...
     * Loads <code>Report</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Report getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Report with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Report getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Report) cacheGet(id);
    }
