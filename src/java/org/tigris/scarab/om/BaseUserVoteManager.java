    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.UserVote";
     ...
     * Loads <code>UserVote</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static UserVote getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a UserVote with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected UserVote getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (UserVote) cacheGet(id);
    }
