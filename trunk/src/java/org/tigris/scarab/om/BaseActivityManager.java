    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Activity";
     ...
     * Loads <code>Activity</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Activity getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Activity with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Activity getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Activity) cacheGet(id);
    }
