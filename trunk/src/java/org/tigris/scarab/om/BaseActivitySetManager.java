    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.ActivitySet";
     ...
     * Loads <code>ActivitySet</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static ActivitySet getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a ActivitySet with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected ActivitySet getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (ActivitySet) cacheGet(id);
    }
