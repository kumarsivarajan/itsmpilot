    ...
    implements org.apache.fulcrum.intake.Retrievable
{
     ...
     *
     * @param key attachmentTypeId ObjectKey
     */
    public void setPrimaryKey(ObjectKey key)
        throws TorqueException
    {
            setAttachmentTypeId(new Integer(((NumberKey) key).intValue()));
        }
    ...
    {
        return copyInto(new AttachmentType());
    }
  
    protected AttachmentType copyInto(AttachmentType copyObj) throws TorqueException
    {
