    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.AttributeOption";
     ...
     * Loads <code>AttributeOption</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeOption getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a AttributeOption with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected AttributeOption getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (AttributeOption) cacheGet(id);
    }
