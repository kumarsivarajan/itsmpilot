    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Depend";
     ...
     * Loads <code>Depend</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Depend getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Depend with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Depend getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Depend) cacheGet(id);
    }
