    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Frequency";
     ...
     * Loads <code>Frequency</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Frequency getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Frequency with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Frequency getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Frequency) cacheGet(id);
    }
