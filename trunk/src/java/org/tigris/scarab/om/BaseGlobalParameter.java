    ...
    implements org.apache.fulcrum.intake.Retrievable
{
     ...
     *
     * @param key parameterId ObjectKey
     */
    public void setPrimaryKey(ObjectKey key)
        
    {
            setParameterId(new Integer(((NumberKey) key).intValue()));
        }
    ...
    {
        return copyInto(new GlobalParameter());
    }
  
    protected GlobalParameter copyInto(GlobalParameter copyObj) throws TorqueException
    {
