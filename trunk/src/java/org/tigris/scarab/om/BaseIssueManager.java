    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Issue";
     ...
     * Loads <code>Issue</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Issue getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Issue with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Issue getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Issue) cacheGet(id);
    }
