    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.MITList";
     ...
     * Loads <code>MITList</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static MITList getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a MITList with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected MITList getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (MITList) cacheGet(id);
    }
