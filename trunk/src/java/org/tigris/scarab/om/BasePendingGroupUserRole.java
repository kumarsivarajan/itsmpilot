    ...
    implements org.apache.fulcrum.intake.Retrievable
{
    ...
    public Module getModule()
              throws TorqueException
          {
              if (aModule == null && (!ObjectUtils.equals(this.groupId, null)))
        {
                    aModule = ModuleManager.getInstance(SimpleKey.keyFor(this.groupId));
                }
              return aModule;
    }
        ...
        throws TorqueException
    {
        if (aModule == null && (!ObjectUtils.equals(this.groupId, null)))
        {
                    aModule = ModuleManager.getCachedInstance(SimpleKey.keyFor(this.groupId));
            if (aModule == null)
            {
                          aModule = ScarabModulePeer.retrieveByPK(SimpleKey.keyFor(this.groupId), connection);
    ...
    {
        return copyInto(new PendingGroupUserRole());
    }
  
    protected PendingGroupUserRole copyInto(PendingGroupUserRole copyObj) throws TorqueException
    {
