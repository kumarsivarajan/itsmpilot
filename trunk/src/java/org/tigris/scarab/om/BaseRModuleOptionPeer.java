    ...
    extends BasePeer
{
        ...
        throws TorqueException
    {
        ...
        int offset2 = numColumns + 1;
                    ...
                    ScarabModulePeer.addSelectColumns(criteria);
                                    criteria.addJoin(RModuleOptionPeer.MODULE_ID, ScarabModulePeer.MODULE_ID);
                                    int offset3 = offset2 + ScarabModulePeer.numColumns;
                                                                                
                    IssueTypePeer.addSelectColumns(criteria);
                                    criteria.addJoin(RModuleOptionPeer.ISSUE_TYPE_ID, IssueTypePeer.ISSUE_TYPE_ID);
        ...
        throws TorqueException
    {
        ...
        int offset2 = numColumns + 1;
                    ...
                    AttributeOptionPeer.addSelectColumns(criteria);
                                    criteria.addJoin(RModuleOptionPeer.OPTION_ID, AttributeOptionPeer.OPTION_ID);
