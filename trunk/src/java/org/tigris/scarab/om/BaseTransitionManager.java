    ...
    extends AbstractBaseManager
{
    ...
    protected static final String MANAGED_CLASS = "org.tigris.scarab.om.Transition";
     ...
     * Loads <code>Transition</code> from cache, returns 
     ...
     * @exception TorqueException if an error occurs
     */
    public static Transition getCachedInstance(ObjectKey id)
        throws TorqueException
    {
    ...
    /**
     * Get a Transition with the given id from the cache. Returns 
     * <code>null</code> if instance is not in cache
     *
     * @param id <code>ObjectKey</code> value
     */
    protected Transition getCachedInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Transition) cacheGet(id);
    }
